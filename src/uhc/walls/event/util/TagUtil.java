...
public class TagUtil {
	...
	/**
	 * These are the players with either a prefix or
	 * a suffix in their nameplate. If they do not have a
	 * prefix or suffix they will not be in the list.
	 * 
	 ...
	 * @see UUID
	 */
	@Getter private static ArrayList<UUID> playersWithTags = new ArrayList<UUID>();
	
	/**
	 * These are the players with prefixes in 
	 * their nametags. If they do not have a prefix
	 * their UUID will not be in this list.
	 * 
	 * @since ProjectParty-0.0.1-SNAPSHOT
	 * 
	 * @author 598Johnn897
	 ...
	 * @see UUID
	 */
	@Getter private static ArrayList<UUID> playersWithPrefixes = new ArrayList<UUID>();
	
	/**
	 * Theses are the players with suffixes
	 * in their nametags. If they do not have a
	 * suffix their UUID will not be in this list.
	 * 
	 * @since ProjectParty-0.0.1-SNAPSHOT
	 * 
	 * @author 598Johnn897
	 ...
	 * @see UUID
	 */
	@Getter private static ArrayList<UUID> playersWithSuffixes = new ArrayList<UUID>();
	
	/**
	 * This returns true or false if the players 
	 * has a prefix or suffix in their nametag.
	 * 
	 * @since ProjectParty-0.0.1-SNAPSHOT
	 * 
	 * @author 598Johnn897
